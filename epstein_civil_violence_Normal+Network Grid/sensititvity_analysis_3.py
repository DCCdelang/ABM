...
data_file_name = "SA_data_Cat/SA_data_Cat_3/SA_data_Cat_3.csv"
...
for i in range(replicates):
    for vals in param_values:
        ...
        iteration_data[1].to_csv("SA_data_Cat/SA_data_Cat_3/" + title + "-" + str(i)+"_iteration.csv")
