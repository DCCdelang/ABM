...
param_Cat = param_values[100:120]
...
param_values = param_Cat
data_file_name = "SA_data_Cat/SA_data_Cat_6/SA_data_Cat_6.csv"
...
for i in range(replicates):
    for vals in param_values:
        ...
        iteration_data[1].to_csv("SA_data_Cat/SA_data_Cat_6/" + title + "-" + str(i)+"_iteration.csv")
...
exit()
#%%
data_from_csv = pd.read_csv("SA_data/SA_data_Cat/SA_data_Cat.csv")
